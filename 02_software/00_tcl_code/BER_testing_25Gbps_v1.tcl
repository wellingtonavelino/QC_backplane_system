...
# Program the FPGA with the iBERT bitstream
...
# If no links found. Set them manually
set xil_newLinks [list]
set tx_path "$ibert/Quad_130/MGT_X0Y15/TX"
set rx_path "$ibert/Quad_131/MGT_X0Y17/RX"
